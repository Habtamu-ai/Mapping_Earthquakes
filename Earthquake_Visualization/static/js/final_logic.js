...
// 1. Add a three layer group for all earthquake,the tectonic plate and magor earthquake data.
let allEarthquakes = new L.LayerGroup();
let tectonic = new L.LayerGroup();
let majorEarthquake = new L.LayerGroup();

// 2. Add a reference to the three overlays objects.
let overlays = {
...
//Retrive the major(>4.5) erthquake GeoJson data.
